...
//
//  ListHomesTableViewController.swift
//  HomeKitDemo
//
...
class ListHomesTableViewController: UITableViewController, HMHomeManagerDelegate {
    ...
    func rightItemClick() {
        let addCaloriesVC: AddHomeViewController = AddHomeViewController()
